...
[Verb(name: "tcpClient", isDefault: false)]
public sealed class TcpClientOptions : BaseOptions
{
    [Option('p', "port", Required = false, HelpText = "Port to connect to.", Default = 11111)]
