...
This is an example on how you can set up `Transceiver` with Kafka. This example can be viewed on [git](https://github.com/glacorSoul/Transceiver/blob/main/Transceiver.Demo/Options/KafkaOptions.cs)
