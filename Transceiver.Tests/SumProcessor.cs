    ...
    IProcessor<UdpSumRequest, UdpSumResponse>
{
    ...
    public async Task<ChannelsSumResponse> ProcessRequestAsync(IClientRequest<ChannelsSumRequest, ChannelsSumResponse> request, CancellationToken cancellationToken)
    {
    ...
    public async Task<DomainSocketsSumResponse> ProcessRequestAsync(IClientRequest<DomainSocketsSumRequest, DomainSocketsSumResponse> request, CancellationToken cancellationToken)
    {
    ...
    public async Task<UdpSumResponse> ProcessRequestAsync(IClientRequest<UdpSumRequest, UdpSumResponse> request, CancellationToken cancellationToken)
    {
